              ...
              <?php if ($teacher->R_status == "รอพิจารณา" && $teacher->DS_id == "ยังไม่ได้อัพเอกสารขอความอนุเคราะห์") { ?>
                <div class="column">
                  <div class="box">
                    ...
                    <a href="?controller=teacher&action=addAP_request&<?php echo "R_id=$teacher->R_id"?>&<?php echo "AP_approve='อนุมัติ'"?>&<?php echo "A_id=$userid"?>
                    &<?php echo "AP_note=''"?>" class="btn btn-success" role="button" data-bs-toggle="button">อนุมัติ</a>
